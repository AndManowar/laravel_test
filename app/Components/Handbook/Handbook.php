...
class Handbook implements HandbookInterface
{
    ...
    public function getList($id = null)
    {
        if ($id == null) {
            ...
            return HandbookModel::query()->pluck('systemName', 'id')->all();
        }

        return HandbookModel::query()->where('id', '!=', $id)->pluck('systemName', 'id')->all();
    }
    ...
    {
        return collect($this->get($name)->handbookData)->where('data_id', '=', $data_id)->first();
    }
