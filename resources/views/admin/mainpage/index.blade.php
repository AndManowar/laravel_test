                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="list-inline text-xs-center pt-2 m-0">
                                <li class="mr-1">
                                    <h6><i class="icon-circle warning"></i> <span class="grey darken-1">Remaining</span>
                                    </h6>
                                </li>
                                <li class="mr-1">
                                    <h6><i class="icon-circle success"></i> <span class="grey darken-1">Completed</span>
                                    </h6>
                                </li>
                            </ul>
            ...
            <div class="row match-height">
                ...
                <div class="col-xl-8 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-block">
                                <p>Total paid invoices 240, unpaid 150. <span class="float-xs-right"><a href="#">Invoice Summary <i
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate"><span class="tag tag-default tag-success">Paid</span>
                                        </td>
            ...
            <div class="row match-height">
                <div class="col-xl-4 col-md-6 col-sm-12">
                    <div class="card" style="height: 440px;">
                        <div class="card-body">
                            <img class="card-img-top img-fluid" src="{{ asset('admin/images/carousel/05.jpg') }}"
                                 alt="Card image cap">
                            <div class="card-block">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <span class="tag tag-default tag-pill bg-primary float-xs-right">4</span> Cras justo
                                    odio
                                </li>
                                <li class="list-group-item">
                                    <span class="tag tag-default tag-pill bg-info float-xs-right">2</span> Dapibus ac
                                    facilisis in
                                </li>
                                <li class="list-group-item">
                                    <span class="tag tag-default tag-pill bg-warning float-xs-right">1</span> Morbi leo
                                    risus
                                </li>
                                <li class="list-group-item">
                                    <span class="tag tag-default tag-pill bg-success float-xs-right">3</span> Porta ac
                                    consectetur ac
                                </li>
                                <li class="list-group-item">
                                    <span class="tag tag-default tag-pill bg-danger float-xs-right">8</span> Vestibulum
                                    at eros
                                </li>
                            </ul>
                            <div class="card-block">
                            ...
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item">
                                        <img src="{{ asset('admin/images/carousel/02.jpg') }}" alt="First slide">
                                    </div>
                                    <div class="carousel-item active">
                                        <img src="{{ asset('admin/images/carousel/03.jpg') }}" alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{ asset('admin/images/carousel/01.jpg') }}" alt="Third slide">
                                    </div>
                                </div>
