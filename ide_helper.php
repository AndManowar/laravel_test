 ...
 * Generated for Laravel 5.6.20 on 2018-05-03 09:19:46.
 *
...
namespace App\Facades { 
    ...
    class Handbook {
        ...
        {
            return \App\Services\handbook\Handbook::get($name);
        }
        ...
        {
            return \App\Services\handbook\Handbook::getList();
        }
        ...
        {
            \App\Services\handbook\Handbook::setToCache();
        }
        ...
        {
            \App\Services\handbook\Handbook::readFromCache();
        }
        ...
        {
            return \App\Services\handbook\Handbook::getRecord($name, $data_id);
        }
...
namespace  { 
    ...
    class Handbook extends \App\Facades\Handbook {}
